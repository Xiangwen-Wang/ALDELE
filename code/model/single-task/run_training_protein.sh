...
python run_training_protein.py $DATASET $radius $ngram $dim $window $layer_cnn $layer_nn $layer_output $lr $lr_decay $decay_interval $weight_decay $iteration $setting
